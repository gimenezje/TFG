...
google.charts.load('current', {packages: ['corechart', 'table', 'controls'],
    language: 'es',
    mapsApiKey: 'AIzaSyBCZp1EH6Ujo2Kfab-MGgohcXDMH8mTRzI'
});
...
function cuadroMando() {
    ...
    var data = google.visualization.arrayToDataTable(eval(zep_data));
    ...
    // el gráfico de mapa y la tabla
    dashboard.bind([dropDownList1, dropDownList2], geoChart)
            .bind([dropDownList1, dropDownList2], table);
